  ...
  return <details className="about-search">
    ...
    <div className="about-content">
      ...
      <div className="about-grid">
        ...
        <div><span>04</span><h3>A little conversation helps</h3><p>Contextual ranking also considers nearby messages. The highlighted bubble is always the actual retrieved message.</p></div>
      </div>
